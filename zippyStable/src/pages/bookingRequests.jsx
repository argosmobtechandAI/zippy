...
const BookingRequests = () => {
    ...
    useEffect(() => { fetchSessions(); }, [selectedStable]);
    ...
    }, [tabFiltered, selectedDate]);

    // Counts per tab
    const counts = useMemo(() => {
        const c = { ALL: allParticipants.length };
        ...
        <div className="p-10 max-w-[1400px] mx-auto min-h-full bg-[#F6EDE2] w-full font-sans">
            ...
            <div className="mb-6">
                ...
                <div className="flex justify-between items-end">
                    <div>
                        <h1 className="text-[34px] font-black text-[#1e2330] leading-none mb-2 tracking-tight">Booking Requests</h1>
                        <p className="text-[14px] font-semibold text-gray-500">Review, approve or reject rider booking requests.</p>
                    </div>
                ...
                {filteredParticipants.length > 0 && (
                    <div className="flex justify-between items-center mt-8">
                        <div className="text-[13px] font-bold text-gray-500">
                            Showing {((currentPage - 1) * ITEMS_PER_PAGE) + 1}–{Math.min(currentPage * ITEMS_PER_PAGE, filteredParticipants.length)} of {filteredParticipants.length} bookings
                        </div>
