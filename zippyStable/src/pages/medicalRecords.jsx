...
import { getHorsesByStableApi, baseUrl, logVaccinationApi, logHealthApi } from '../api/apis';
...
const MedicalRecords = () => {
    ...
    const fetchHorses = async (silent = false) => {
        ...
        try {
            const res = await apiFunction(getHorsesByStableApi, [selectedStable], {}, 'GET', true);
            if (res?.success) {
