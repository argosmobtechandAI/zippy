...
const SlotManagement = () => {
    ...
    const fetchData = async () => {
        ...
        try {
            ...
            if (batchRes?.success) setBatches(batchRes.batch || []);
    ...
    if (!selectedBatch) {
        return (
            <div className="p-10 max-w-[1400px] mx-auto min-h-full bg-[#F6EDE2] w-full font-sans">
                ...
                {showBatchModal && <BatchModal batchToEdit={batchToEdit} setShowModal={setShowBatchModal} onSuccess={fetchData} stables={stables} />}
            </div>
        );
    }
...
const BatchModal = ({ batchToEdit, setShowModal, onSuccess, stables }) => {
